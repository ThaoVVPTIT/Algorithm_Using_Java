...
public class QickSort {
	...
	public static void main(String arg[])
	{
		...
		System.out.println("Testing Sorting Using QickSort");
		System.out.println();
		...
		while(t > 0)
		{
			...
			System.out.println("Arrays before Sorting using Qick Sort is");
			System.out.print("[");
			for(int i = 0; i < n; i++)
			{
			...
			System.out.println("Arrays AFTER using QickSort is");
